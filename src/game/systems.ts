...
export const SYSTEMS: BodySystem[] = [
  {
    ...
    ranks: bodyRanks,
    parts: [
      { id: "head", name: "Head", icon: "🙂", fact: "Holds your brain, eyes, ears, nose, and mouth.", x: 50, y: 8 },
      { id: "eye", name: "Eye", icon: "👁️", fact: "Lets you see colors, shapes, and everything around you.", x: 43, y: 11 },
      { id: "ear", name: "Ear", icon: "👂", fact: "Collects sound on both sides of your head.", x: 60, y: 13 },
      { id: "nose", name: "Nose", icon: "👃", fact: "Helps you smell and breathe in air.", x: 50, y: 14 },
      { id: "mouth", name: "Mouth", icon: "👄", fact: "Used for eating, talking, and smiling.", x: 50, y: 18 },
      { id: "neck", name: "Neck", icon: "🧣", fact: "Connects your head to your body and lets you look around.", x: 50, y: 24 },
      { id: "arm", name: "Arm", icon: "💪", fact: "Connects your shoulder to your hand so you can reach and lift.", x: 24, y: 40 },
      { id: "hand", name: "Hand", icon: "✋", fact: "Grabs, holds, writes, and helps you touch the world.", x: 17, y: 56 },
      { id: "leg", name: "Leg", icon: "🦵", fact: "Carries your weight and helps you walk, run, and jump.", x: 61, y: 74 },
      { id: "foot", name: "Foot", icon: "🦶", fact: "Balances your body and pushes off the ground when you move.", x: 63, y: 93 },
    ],
  },
  {
    id: "core-organs",
