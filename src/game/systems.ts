...
export const SYSTEMS: BodySystem[] = [
  {
    ...
    ranks: bodyRanks,
    parts: [
      { id: "head", name: "Head", icon: "🙂", fact: "Holds your brain, eyes, ears, nose, and mouth.", x: 51, y: 10 },
      { id: "eye", name: "Eye", icon: "👁️", fact: "Lets you see colors, shapes, and everything around you.", x: 41, y: 19 },
      { id: "ear", name: "Ear", icon: "👂", fact: "Collects sound on both sides of your head.", x: 27, y: 20 },
      { id: "nose", name: "Nose", icon: "👃", fact: "Helps you smell and breathe in air.", x: 49, y: 21 },
      { id: "mouth", name: "Mouth", icon: "👄", fact: "Used for eating, talking, and smiling.", x: 47, y: 25 },
      { id: "neck", name: "Neck", icon: "🧣", fact: "Connects your head to your body and lets you look around.", x: 49, y: 32 },
      { id: "arm", name: "Arm", icon: "💪", fact: "Connects your shoulder to your hand so you can reach and lift.", x: 27, y: 42 },
      { id: "hand", name: "Hand", icon: "✋", fact: "Grabs, holds, writes, and helps you touch the world.", x: 23, y: 59 },
      { id: "leg", name: "Leg", icon: "🦵", fact: "Carries your weight and helps you walk, run, and jump.", x: 59, y: 73 },
      { id: "foot", name: "Foot", icon: "🦶", fact: "Balances your body and pushes off the ground when you move.", x: 60, y: 88 },
    ],
  },
  {
    id: "core-organs",
